...
$\displaystyle\sum_{i=1}^{n}{ e_i^2} = \displaystyle\sum_{i=1}^{n}{(y_i - y\hat{}_i)^2} = \displaystyle\sum_{i=1}^{n}{(y_i - \beta\hat{}_0 - \hat{\beta}_1 x_{i1} - \hat{\beta}_2 x_{i2} - \cdots - \hat{\beta}_p x_{ip})^2}$
